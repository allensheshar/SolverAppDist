        ...
        $.Imprimir = function (index) {
            ...
            var optionsToServer = {
                ...
                querys: [
                    ...
                    //    name: 'tblTotalSoles',
                    //    args: $.ConvertObjectToArr({
                    //        script: 'q_gbl_cuadre_caja_tabla_soles_total',
                    //        C_EMPRESA: $.solver.session.SESSION_EMPRESA,
                    //        C_CAJA: row['C_CAJA'],
                    //        C_USUARIO: row['Vendedor'],
                    //        C_FECHA: row['C_FECHA'],
                    ...
                    //},
                    //{
                    //    name: 'tblTotalDolares',
                    //    args: $.ConvertObjectToArr({
                    //        script: 'q_gbl_cuadre_caja_tabla_dolares_total',
                    //        C_EMPRESA: $.solver.session.SESSION_EMPRESA,
                    //        C_CAJA: row['C_CAJA'],
                    //        C_USUARIO: row['Vendedor'],
                    //        C_FECHA: row['C_FECHA'],
                    ...
                    //},
                    //{
                    //    name: 'tblTotalTarjetas',
                    //    args: $.ConvertObjectToArr({
                    //        script: 'q_gbl_cuadre_caja_tabla_tarjeta_total',
                    //        C_EMPRESA: $.solver.session.SESSION_EMPRESA,
                    //        C_CAJA: row['C_CAJA'],
                    //        C_USUARIO: row['Vendedor'],
                    //        C_FECHA: row['C_FECHA'],
